    ...
    <section className="relative flex justify-between items-center mt-32 3bp:mt-20 3bp:flex-col-reverse 3bp:gap-12 7bp:mt-12">
      <div className="flex flex-col 3bp:items-center 3bp:text-center">
        ...
        <p className="max-w-[445px] text mb-16 2bp:mb-8 3bp:max-w-[500px]">
          I&apos;m a <span className="font-bold text-xl">Junior Frontend developer</span> passionate about
          everything related to UI/UX, so I find my passion in converting
          designs & ideas to code.
        </p>
     ...
     <div className="absolute right-0 z-[-1] 3bp:relative">
      <div className="relative w-fit h-fit">
        <Image
          className="rounded-full min-w-[445px] w-[445px] min-h-[445px] h-[445px] z-[-1] 7bp:w-[245px] 7bp:min-w-[345px] 7bp:min-h-[245px] 7bp:h-[345px]"
          src={codezeloss}
          alt="Codezeloss"
          priority
        />
        <div className="absolute w-fit h-fit bottom-[20px] right-[300px] z-[-5] 7bp:right-[220px]"><Image
          className="rounded-full min-w-[129px] min-h-[129px]"
          src={circle}
          alt="Rings"
        /></div>
      </div>

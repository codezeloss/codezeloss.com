    ...
    <section className="relative flex justify-between items-center mt-32 3bp:mt-20 3bp:flex-col-reverse 3bp:gap-12 7bp:mt-12">
      <div className="flex flex-col 3bp:items-center 3bp:text-center">
        ...
        <p className="max-w-[445px] text mb-16 2bp:mb-8 3bp:max-w-[500px]">
          ...
          I convert designs & ideas to code. React/Nextjs are the tools I love to work with. I code responsive websites/apps from scratch and contribute to existing projects.
Usable, enjoyable, and accessible User Interfaces are the motivation and the goals I work towards achieving every day.
        </p>
